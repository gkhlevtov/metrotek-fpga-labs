...
set_output_delay -clock clk_150 -max 0.0  [get_ports {deser_data_o[*] deser_data_val_o}]
set_output_delay -clock clk_150 -min 0.0  [get_ports {deser_data_o[*] deser_data_val_o}]