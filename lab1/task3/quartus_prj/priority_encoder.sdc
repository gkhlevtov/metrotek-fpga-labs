...
set_output_delay -clock clk_150 -max 0.0  [get_ports {data_left_o[*] data_right_o[*] data_val_o}]
set_output_delay -clock clk_150 -min 0.0  [get_ports {data_left_o[*] data_right_o[*] data_val_o}]